...
```
string umoneyRefund(string referralcode, string ezTransactionId)
```
...
### 1.14.1. Umoney карт буцаалт хийхэд шаардлагатай параметрүүд
...
### 1.14.2. Umoney карт сүүлийн цэнэглэлт буцаалтын хүсэлтийн хариу
