...
| Attribute | Төрөл   | Тайлбар                 | Заавал |
| --------: | ------- | :---------------------- | ------ |
|   `posId` | sttring | Пос төхөөрөмжийн дугаар | Тийм   |
...
```
${BASE_URL}\inquiry\transaction\:referralcode хаяг руу GET хүсэлт илгээнэ
```
...
| Параметр     | Төрөл  | Тайлбар                                                                                 |
| ------------ | ------ | --------------------------------------------------------------------------------------- |
| referralcode | string | Гүйлгээ хийх үед дамжуулсан утга байна, `:referralcode` param буюу url хэсэгт дамжуулна |
